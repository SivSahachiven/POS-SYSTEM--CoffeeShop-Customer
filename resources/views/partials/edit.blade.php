         ...
         <div class="row">
              <div class="col-6">
                    @csrf
                      <fieldset> 
                        <div class="mb-3">
                          <label id="text" for="disabledTextInput" class="form-label">Customer Name</label>
                        ...
                        <div class="mb-3">
                          <label id="text" for="disabledTextInput" class="form-label">Company Name</label>
                        ...
                        <div class="mb-3">
                          <label id="text" for="disabledTextInput" class="form-label">Email</label>
                          <input type="text" name="email" id="email" value="{{ old('email', $customer->email) }}"class="form-control" placeholder="Disabled input">
                        </div>
                        <div class="mb-3">
                          <label id="text" for="disabledTextInput" class="form-label">Phone Number</label>
                    ...
                    <div class="col-6">
                      <div class="mb-3">
                        <label id="text" for="disabledTextInput" class="form-label">Address</label>
                        ...
                        <textarea name="address" style="height: 150px; vertical-align: top;" id="address" class="form-control blue-text" placeholder="">{{ old('address', $customer->address) }}</textarea>
                      </div>
                      ...
                      <div class="form-check form-switch">
                        ...
                        <label id="text" class="form-check-label" for="is_hidding">is Hidding</label>
                    </div>                    
