                ...
                <div class="col-6">
                      ...
                      <div class="col-6">
                        <div class="mb-3">
                          ...
                          <textarea name="address" style="height: 150px; vertical-align: top;" id="address" class="form-control blue-text" placeholder="Enter Email"></textarea>
                        </div>
                        
                        
                        <div class="form-check form-switch">
                          <input name="is_hidding" class="form-check-input" type="checkbox" role="switch" id="is_hidding">
                          <label id="text" class="form-check-label" for="flexSwitchCheckDefault">is Hidding</label>
                        </div>
