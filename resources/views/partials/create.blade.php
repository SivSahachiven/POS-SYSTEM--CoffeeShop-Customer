           ...
           <div class="row">
                ...
                <div class="col-6">
                    <form >
                        <fieldset>
                            <div class="mb-3">
                                ...
                                <textarea style="height: 150px; vertical-align: top;" id="disabledTextInput" class="form-control" placeholder=""></textarea>
                            </div>
                        </fieldset>
                    ...
                    <div class="d-grid gap-1 d-md-flex justify-content-md-end position-absolute bottom-0 end-0" style="padding:0 25px 25px 0" >
                        <button style="border-radius: 20px; width:110px;" class="btn btn-primary" type="button">Create</button>
                        <button style="border-radius: 20px; width:110px;" class="btn btn-primary" type="button">Cancel</button>
                    </div>
                </div>
           </div>
        </div>
